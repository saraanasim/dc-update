...
import logoLightImg from "./assets/logoLight.png"; //Relative Path (Path of Target Image from Current Location)
    ...
    <div>
        ...
        <div class="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
          <div className=" text-center text-white  pt-7 body-font">
            <p className="font-bold text-white text-7xl body-font">
              Reinventing Social Commerce with{" "}
              <span className="text-red-500 text-7xl">AI</span>
            </p>
            <h2 className="font-bold text-white text-4xl body-font"></h2>
          </div>
          ...
          <div class="text-center lg:w-2/3 w-full py-5 ">
            <p class="leading-relaxed mb-8 text-white">
              Sadiq uses advance AI and AR tech to enhance social commerce , Our
              platform connects influcers, creators, buyer, sellers , providing
              a highly personalized experence{" "}
            </p>
          </div>
        </div>
      </section>
      <section class="bg-white dark:bg-white-900 py-24">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          <img
            ...
            src="src\compnents\influencers.png"
            alt="dashboard image"
          />
          <img
          ...
          <div class="mt-4 md:mt-0">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black">
              Shop Like A Pro.
            </h2>
            <p class="mb-6 font-medium text-black-500 md:text-lg dark:text-black-400">
      ...
      <section class="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-gray-400 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          <div class="flex flex-col text-center w-full mb-20">
            <p class="font-bold text-white text-7xl body-font">
              Fast, Smart, Effortless Shopping{" "}
            </p>
          </div>
              ...
              <div class="flex rounded-lg h-full bg-gray-800 bg-opacity-60 p-8 flex-col">
                ...
                <div class="flex-grow">
                  <p class="leading-relaxed text-base">
                    ...
                    <br class="hidden lg:inline-block" /> four dollar toast
          ...
          <div class="container mx-auto flex px-5 py-15 md:flex-row flex-col items-center">
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
              <img
                ...
                alt="hero"
                src="src\compnents\touch.png"
              />
            </div>
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              <p class="font-bold text-white text-4xl body-font pb-6">
                Human AI Transformation of user experience
              </p>
              <p class="mb-8 leading-relaxed">
                Sadiq brings predictive, hyper-personalized experience ,
                <br class="hidden lg:inline-block" /> putting users first for
                expectional experience .
              </p>
            </div>
          </div>
        </section>
        ...
        <div class="container px-5 py-10 mx-auto">
          <div class="flex flex-col">
            <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
              <div class="flex flex-col text-center w-full mb-20">
                <p class="font-bold text-black text-6xl body-font pb-6">
                  Real Time AR Shopping
                </p>
                <p class="leading-relaxed text-base text-black">
                  Blue bottle crucifix vinyl post-ironic{" "}
                  <br class="hidden lg:inline-block" /> four dollar toast vegan
      ...
      <section class=" bg-gradient-to-r from-green-300 to-voliet-900 text-gray-400  body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          <div class=" flex-col text-center w-full mb-20">
            <p class="font-bold text-black text-6xl body-font">
              Future of Shopping with AR try-on
            </p>
            <p class="py-4 leading-relaxed text-base text-black">
              {" "}
              Virtual try-on enables users to preview{" "}
              <br class="hidden lg:inline-block" /> products before purchase
              using compter vision, AR filters and user photos
            </p>
          </div>
      ...
      <section class="text-gray-400 bg-gradient-to-r from-red-600 to-violet-500 body-font py-24">
        <div class="container px-5 py-15 mx-auto flex flex-wrap">
          <div class=" flex-col text-center w-full mb-20">
            <h1 class="font-bold text-white text-6xl body-font">
              Shop worry-free with virtual measurements
            </h1>
            <p class="py-4 leading-relaxed text-base">
              {" "}
              we enable buyers to focus on the shopping without worrying about
              size and minimal returns <br class="hidden lg:inline-block" /> Our
              virtual measurements tool allows shoppers to shop{" "}
              <br class="hidden lg:inline-block" /> without sizing worries or
              minimal returns. using computer vision and image processing it
              measures various body dimensions with high precision
            </p>
          </div>
        </div>
      ...
      <section class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <div class="text-center lg:w-2/3 w-full">
            <h1 class="font-bold text-white text-5xl body-font pb-6">
          ...
          <img
            class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded"
            alt="hero"
            src="src\compnents\generative.png"
          />
          <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
            <p class="text-center leading-relaxed mb-8 flex justify-center">
              Meggings kinfolk echo park stumptown DIY, kale chips{" "}
              <br class="hidden lg:inline-block" /> beard jianbing tousled.
              Chambray dreamcatcher trust fund, kitsch vice godard disrupt ramps
              hexagon mustache umami snackwave tilde chillwave ugh. Pour-over
      ...
      <section class="text-gray-400 bg-gradient-to-r from-fuchsia-500 to-cyan-500 py-24 body-font">
        <div class="container mx-auto flex px-5 py-15 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <h3 class="title-font text-center sm:text-3xl text-3xl mb-4 font-medium text-white">
              Empowering People through meaningfull innovations
              <br class="hidden lg:inline-block font-small text-white" />
            </h3>
            <p class="mb-8 leading-relaxed">
      ...
      <section class="text-gray-400 bg-gradient-to-r from-teal-400 to-yellow-200 body-font bg-gray-900">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col py-24 text-center w-full mb-20">
            ...
            <p class="py-5 lg:w-2/3 mx-auto text-black leading-relaxed text-base">
      ...
      <section class="bg-center bg-cover bg-no-repeat bg-[url('https://tailwindcomponents.com/gradient-generator/assets/header.a6837f08.webp')] bg-blend-multiply text-gray-400 bg-gray-500 body-font">
        <div class="container px-5 py-24 mx-auto px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
          <div class="flex flex-col text-center w-full mb-20">
            <h1 class="font-bold text-white text-6xl body-font pb-6">
              OUR TEAM
            </h1>
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
              <div class="h-full flex flex-col items-center text-center">
                <img
                  alt="team"
                  class="block h-full w-full rounded-lg object-cover object-center"
                  src="src\compnents\zulfiqar.png"
                />
                <div class="w-full">
                  <h2 class="title-font font-medium text-lg text-white">
                    Zulfiqar Ahmed
      ...
      <section class="text-gray-400 bg-gradient-to-t from-red-600 to-indigo-600 body-font">
        <div class="container mx-auto flex px-5 py-40 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="font-bold text-white text-5xl body-font ">
              Bringing People Together
            </h1>
            <p class="py-5 mb-8 leading-relaxed">
              Copper mug try-hard pitchfork pour-over freegan heirloom neutra
              air plant cold-pressed tacos poke beard tote bag. Heirloom echo
              park mlkshk tote bag selvage hot chicken authentic tumeric
              truffaut hexagon try-hard chambray.
      ...
      <footer class="text-gray-400 bg-gray-900 body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <a href="#" class="flex items-center mb-4 sm:mb-0">
            <img
              src="src\compnents\logoLight.png"
              class="h-8 mr-3"
              alt="Flowbite Logo"
            />
